...
If you want, the bank API has been deployed on the Apoorva Hosting Service (uptime not garanteed, no SLA provided, no support provided). However we can garantee that the servers are France, maybe in Europe, maybe somewhere else.
